import type { child, serviceTypes } from "../types/types.services";
import type { Constructor } from "../types/types.api";

import { writeFileSync, mkdirSync } from "node:fs";
import * as path from "node:path";
import os from "os";
import { auditFilepath, buildJsFileString, logger, stringToTsBlob } from "../utils";
...
export class Service<T extends serviceTypes> {
      ...
      private makeWindow = async () => {
            ...
            this.child = buildJsFileString(this.filePath, true, ARGS) as child<T>;
      };
